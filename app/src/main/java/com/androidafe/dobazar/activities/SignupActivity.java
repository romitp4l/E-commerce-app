        ...
        if (userMail.isEmpty()) {
            ...
            call.enqueue(new Callback<UserResponse>() {
                ...
                public void onFailure(Call<UserResponse> call, Throwable t) {
                 //   Toast.makeText(SignupActivity.this, "Registration failed: " + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                   // Log.d("SignupActivity", "onFailure: " + t.getLocalizedMessage());
                }
            });
        }
    }
